...
var _user$project$Bingo$sumMarkedWords = function (words) {
	return A3(
		_elm_lang$core$List$foldl,
		F2(
			function (w, sum) {
...
var _user$project$Bingo$pageHeader = function (title) {
	return A2(
...
var _user$project$Bingo$stylePlayerHtml = F2(
	function (name, gameNumber) {
		var playerInfoHtml = _elm_lang$html$Html$text(
		...
		switch (_p0.ctor) {
			...
			case 'NewGame':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						player,
						{words: _user$project$Bingo$initialWords}),
					{
						ctor: '::',
						_0: _user$project$Bingo$generateRandomNumber,
						_1: {ctor: '[]'}
					});
			default:
	...
	return A2(
		_elm_lang$html$Html$li,
		{
			...
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'marked', _1: word.marked},
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Bingo$Mark(word.id)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$Bingo$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$Bingo$initialPlayer, _1: _user$project$Bingo$generateRandomNumber},
		view: _user$project$Bingo$pageContent,
